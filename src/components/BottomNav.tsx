...
const tabs: { key: TabName; label: string; icon: typeof Scissors; badge?: string; special?: boolean }[] = [
  { key: 'booking', label: 'الحجز', icon: Scissors },
  { key: 'appointments', label: 'المواعيد', icon: CalendarDays, badge: '2' },
...
export default function BottomNav() {
  const { activeTab, setActiveTab, themeConfig, unreadCount } = useApp();
